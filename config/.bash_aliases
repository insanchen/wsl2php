...
alias logclear="sudo find /var/log -type f -regex '.*\.gz$' -delete && sudo find /var/log -type f -regex '.*\.[0-9]$' -delete && sudo truncate -s 0 /var/log/**/*.log"
alias allclear="aptclear && logclear && rm ~/.bash_history"
...
alias redisconf="sudo truncate -s 0 /etc/redis/redis.conf && sudo nano /etc/redis/redis.conf"
...
alias ap2conf="sudo truncate -s 0 /etc/apache2/sites-available/localhost.conf && sudo nano /etc/apache2/sites-available/localhost.conf"
...
alias ngxconf="sudo truncate -s 0 /etc/nginx/sites-available/localhost.conf && sudo nano /etc/nginx/sites-available/localhost.conf"
...
# MySQL / Mariadb
alias mdbboot="sudo service mysql restart"
alias mdbconf="sudo truncate -s 0 /etc/my.cnf && sudo nano /etc/my.cnf"
alias mdbedit="sudo nano /etc/my.cnf"
alias mdbstat="sudo service mysql status"
alias mdbstop="sudo service mysql stop"
